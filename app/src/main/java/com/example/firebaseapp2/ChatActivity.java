...
public class ChatActivity extends AppCompatActivity {
    ...
    private void sendCloudMessage(chatMessage m) {
        String serverKey = "AAAAcf7wOi0:APA91bGerDEmW6P5Uu98ydC3y-mEsYyIZLVQ0i1cWfeU0pZ3suDaU0Zi57hVGIk7B0bHK7YlLyZdcI8niEboZUg9lAsDLVWK5V1TNz6Rah1PF1LschLZKIqPFicHMZmxAtLUsh0Vob1l";
        String topic = "chat";
